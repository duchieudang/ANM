...
<div class="container mt-5">
    <div class="card shadow p-4">
        ...
        <div class="mb-3">
            <label class="form-label"><strong>Giá trị p, q, g, x, y, k:</strong></label>
            <div class="bg-light border p-3" style="white-space: nowrap; overflow-x: auto;">
                p = ${p}, q = ${q}, g = ${g}, x = ${x}, y = ${y}, k = ${k}
            </div>
        </div>
		...
		<input type="hidden" name="bam" value="${bam}">
            ...
            <div class="mb-3">
                <label for="file" class="form-label"><strong>Văn bản cần xác thực</strong></label>
