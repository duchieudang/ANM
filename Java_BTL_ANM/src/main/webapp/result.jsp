...
s
			...
			<form action="xtupload" method="post" enctype="multipart/form-data">
				...
				<div class="mb-3">
					<label for="file" class="form-label"><strong>Văn
							bản cần xác thực</strong></label> <input type="file" name="file" id="file"
						accept=".docx,.pdf,.xlsx" class="form-control" required>
				</div>
