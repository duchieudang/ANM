...
<body class="bg-light">
	<div class="container mt-5">
		<div class="card shadow p-4">
			<h2 class="card-title text-center mb-4">🔐 Kết quả ký và xác thực DSA</h2>
			<div class="row">
				<!-- Cột 1: Thông tin đã ký -->
				<div class="col-md-6 border-end">
					<div class="mb-4">
						<div class="section-title">📄 Văn bản đã ký:</div>
						<pre class="bg-section border p-3" style="max-height: 300px; overflow: auto; white-space: pre-wrap;">${message}</pre>
					</div>
					...
					<div class="mb-4">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="bg-section border p-2"><strong>r =</strong> ${r}</div>
							</div>
							<div class="col-md-6">
								<div class="bg-section border p-2"><strong>s =</strong> ${s}</div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6">
					...
					<input type="hidden" name="vbg" value="<c:out value='${message}'/>">
    ...
    <div class="col-md-6">
        ...
        <input type="number" name="s2" id="sInput" class="form-control"
               value="${empty s2 ? s : s2}" required>
						...
						<div class="mb-3">
							<label for="file" class="form-label">📁 Tải lên văn bản cần xác thực</label>
							<input type="file" name="file" id="file" accept=".docx,.pdf,.xlsx" class="form-control" required>
						</div>
