					...
					<div class="col-md-6 border-end">
						...
						<div class="row">
							<div class="col-md-12 mb-2">
								<label class="form-label">🔢 Chọn độ dài tham số (bit):</label>
							...
							<div class="col-md-6 mb-2">
								...
								<input type="text" name="q" id="inputQText" class="form-control" value="${q}">
							</div>
							<div class="col-md-6 mb-2">
								<label class="form-label">p (nguyên tố):</label>
								<input type="text" name="p" id="inputPText" class="form-control" value="${p}">
							</div>
							<div class="col-md-6 mb-2">
								<label class="form-label">h (1 &lt; h &lt; p-1):</label>
								<input type="text" name="h" id="inputHText" class="form-control" value="${h}">
							</div>
							<div class="col-md-6 mb-2">
								<label class="form-label">x (0 &lt; x &lt; q):</label>
								<input type="text" name="x" id="inputXText" class="form-control" value="${x}">
							</div>
							<div class="col-md-6 mb-2">
								<label class="form-label">k (1 &lt; k &lt; q):</label>
								<input type="text" name="k" id="inputKText" class="form-control" value="${k}">
							</div>
							<div class="col-md-6 mb-2">
